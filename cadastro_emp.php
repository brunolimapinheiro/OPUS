...
$sql_cadastro = mysqli_query($ligar, "INSERT INTO tb_empregador (nome, usuario, senha, pergunta, recupera, email, sexo, nivel, descricao) values ('$nome','$usuario','$senha' ,'$pergunta','$recupera','$email','$sexo','$nivel','$descricao')");
...
//  caso nao tenha realizado o cadastro
    echo "<script>
        ...
        window.location.href='cadastro_emp2.php';
    </script>";
