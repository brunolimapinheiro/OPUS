        ...
        ?>
            ...
            <tbody>
                      <tr class="table-info">
                        ...
                        <td>
                          <form action="cadastre-se.php" method="POST" class="contact-form" data-aos="fade-up"  role="form">
                        <div class="row">
                ...
                while($dados = $sql_query->fetch_assoc()) {
                    ...
                    <tbody>
                      <tr class="table-info">
                        ...
                        <td><a  href="cadastre-se.php?codi=<?=$dados['id_vagas'] ?>"   id="editar">CANDIDATAR - SE</td>
                      </tr>
